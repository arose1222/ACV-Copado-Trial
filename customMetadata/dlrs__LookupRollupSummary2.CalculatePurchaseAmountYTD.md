...
<CustomMetadata xmlns="http://soap.sforce.com/2006/04/metadata" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    <label>Calculate Purchase Amount YTD</label>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Purchase_Amount_YTD__c</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Winning_Bid_Price__c</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">End_Time__c
Status__c</value>
    </values>
    <values>
        <field>dlrs__RelationshipCriteria__c</field>
        <value xsi:type="xsd:string">End_Time__c = THIS_YEAR AND (Status__c = &apos;counter_accepted&apos; OR Status__c = &apos;ended_accepted&apos; OR Status__c = &apos;counter_original_accepted&apos;)</value>
    </values>
    <values>
        <field>dlrs__RelationshipField__c</field>
        <value xsi:type="xsd:string">buyer_dealership__c</value>
    </values>
    <values>
