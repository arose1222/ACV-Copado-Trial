({
    init: function (cmp, event, helper) {
        ...
        if(cmp.get('v.mydata_ProgramEnrollment') && cmp.get('v.mydata_ProgramEnrollment').length > 0){
            cmp.set('v.mydata', cmp.get('v.mydata_ProgramEnrollment'));
            cmp.set('v.obj', 'ProgramEnrollment');
            cmp.set('v.preSelection', cmp.get('v.selectedRows_ProgramEnrollment'));
        }
...
//        }
    ...
    getSelectedName: function (cmp, event) {
        ...
        else if(obj == 'ProgramEnrollment'){
            cmp.set("v.selectedRows_ProgramEnrollment", selectedRows);   
        }
//        else if(obj == 'custom1'){
